...
- [ ] **FOUN-04**: Gradle build uses version catalogs (libs.versions.toml) consistent with repo conventions
- [ ] **FOUN-05**: ProGuard/R8 rules configured for Ditto SDK in release builds
